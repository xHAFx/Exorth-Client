public class RSDrawingArea extends RSRaster {
	...
	public static void method1437(int drawX, int drawY, int boxWidth, int boxHeight, int color, int alpha) {
		...
		for (int i_166_ = -boxHeight; i_166_ < 0; i_166_++) {
			...
			int i_168_ = i_162_ >> 8;
			int finalColor = (((color & 0xff00ff) * i_167_ + (alpha & 0xff00ff) * i_168_ & ~0xff00ff) + ((color & 0xff00) * i_167_
