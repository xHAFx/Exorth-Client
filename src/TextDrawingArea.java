...
public final class TextDrawingArea extends RSRaster {

	public TextDrawingArea(boolean flag, String s, CacheArchive streamLoader) {
		aByteArrayArray1491 = new byte[256][];
		anIntArray1492 = new short[256];
		anIntArray1493 = new short[256];
		anIntArray1494 = new short[256];
		anIntArray1495 = new short[256];
		anIntArray1496 = new short[256];
		...
		for (int l = 0; l < 256; l++) {
			anIntArray1494[l] = (short) stream_1.readUByte();
			anIntArray1495[l] = (short) stream_1.readUByte();
			int i1 = anIntArray1492[l] = (short) stream_1.readUShort();
			int j1 = anIntArray1493[l] = (short) stream_1.readUShort();
		...
		for (int i1 = 0; i1 < s.length(); i1++) {
			...
			if (c != ' ')
				method392(aByteArrayArray1491[c], j + anIntArray1494[c],
						l + anIntArray1495[c] + (int) (Math.sin((double) i1 / 2D + (double) k / 5D) * 5D), anIntArray1492[c],
						anIntArray1493[c], i);
			j += anIntArray1496[c];
		}
	}
	...
	public void method387(int i, String s, int j, int k, int l) {
		...
		for (int i1 = 0; i1 < s.length(); i1++) {
			char c = s.charAt(i1);
			if (c != ' ')
				method392(aByteArrayArray1491[c], i + anIntArray1494[c] + (int) (Math.sin((double) i1 / 5D + (double) j / 5D) * 5D), k
						+ anIntArray1495[c] + (int) (Math.sin((double) i1 / 3D + (double) j / 5D) * 5D), anIntArray1492[c],
						anIntArray1493[c], l);
			i += anIntArray1496[c];
		}
	}
		...
		for (int k1 = 0; k1 < s.length(); k1++) {
			...
			if (c != ' ')
				method392(aByteArrayArray1491[c], l + anIntArray1494[c],
						k + anIntArray1495[c] + (int) (Math.sin((double) k1 / 1.5D + (double) j) * d), anIntArray1492[c],
						anIntArray1493[c], i1);
			l += anIntArray1496[c];
		}
	}
	...
	public void method389(boolean flag1, int i, int j, String s, int k) {
		...
		for (int i1 = 0; i1 < s.length(); i1++)
			if (s.charAt(i1) == '@' && i1 + 4 < s.length() && s.charAt(i1 + 4) == '@') {
				...
				if (c != ' ') {
					if (flag1)
						method392(aByteArrayArray1491[c], i + anIntArray1494[c] + 1, k + anIntArray1495[c] + 1, anIntArray1492[c],
								anIntArray1493[c], 0);
		...
		if (aBoolean1499)
			RSRaster.method339(k + (int) ((double) anInt1497 * 0.69999999999999996D), 0x800000, i - l, l);
	}
	...
	public void method390(int i, int j, String s, int k, int i1) {
		...
		for (int k1 = 0; k1 < s.length(); k1++)
			if (s.charAt(k1) == '@' && k1 + 4 < s.length() && s.charAt(k1 + 4) == '@') {
				...
				char c = s.charAt(k1);
				if (c != ' ') {
					method394(192, i + anIntArray1494[c] + 1, aByteArrayArray1491[c], anIntArray1492[c], i1 + anIntArray1495[c] + 1,
							anIntArray1493[c], 0);
					method394(j1, i + anIntArray1494[c], aByteArrayArray1491[c], anIntArray1492[c], i1 + anIntArray1495[c],
							anIntArray1493[c], j);
				}
				i += anIntArray1496[c];
	...
	public short[] anIntArray1492;
	public short[] anIntArray1493;
	public short[] anIntArray1494;
	public short[] anIntArray1495;
	public short[] anIntArray1496;
	public short anInt1497;
